...
namespace UC
{
	...
	__declspec(noinline) void _TArrayRemove(void*& Data, int32& NumElements, int32 _Elem_Sz, int32 _Idx);
	...
	public:
		void Append(const TArray<ArrayElementType>& OtherArray)
		{
			for (const ArrayElementType& ArrayElement : OtherArray)
			{
		...
		inline void Remove(int32 Index)
		{
			...
			_TArrayRemove((void*&)Data, NumElements, sizeof(ArrayElementType), Index);
		}

		inline void Remove(const ArrayElementType& Element)
		{
