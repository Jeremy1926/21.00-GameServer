...
void Inventory::Remove(AFortPlayerController* PlayerController, FGuid Guid)
{
	...
	if (Instance)
		if (auto Gadget = Instance->ItemEntry.ItemDefinition->Cast<UFortGadgetItemDefinition>())
			((bool(*)(UFortGadgetItemDefinition*, IInterface*, UFortWorldItem*)) (Sarah::Offsets::ImageBase + 0x6d85a1c))(Gadget, Utils::GetInterface<IFortInventoryOwnerInterface>(PlayerController), Instance);
