...
void UAthenaHUD_C::AllowCursorModeWhenDead(bool* Allow)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AllowCursorModeWhenDead");
...
void UAthenaHUD_C::BindDelegates()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BindDelegates");
...
void UAthenaHUD_C::CheckHUDElementVisibility(struct FGameplayTagContainer& HiddenHUDElementTags, const struct FGameplayTag& HUDElementTagToCheck, class UWidget*& HUDElement)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CheckHUDElementVisibility");
...
void UAthenaHUD_C::EndMatchSpectateLayout(class FName Placement)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EndMatchSpectateLayout");
...
void UAthenaHUD_C::ExecuteUbergraph_AthenaHUD(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaHUD");
...
void UAthenaHUD_C::HandleAircraftModeChanged()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleAircraftModeChanged");
...
void UAthenaHUD_C::HandleFocusChat()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleFocusChat");
...
void UAthenaHUD_C::HandleLocalPawnSet()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleLocalPawnSet");
...
void UAthenaHUD_C::HandlePawnSet_RCPawnVisibilityUpdates(ESlateVisibility InVisibility)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandlePawnSet_RCPawnVisibilityUpdates");
...
void UAthenaHUD_C::HandlePawnSet_VisibilityUpdates(bool& bHideElements)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandlePawnSet_VisibilityUpdates");
...
void UAthenaHUD_C::HandleRevived()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleRevived");
...
void UAthenaHUD_C::HandleToggledBattleMapLive(class ABattleMapPawnLive* NewSpectatorPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleToggledBattleMapLive");
...
void UAthenaHUD_C::IsInVehicleOstrich(class UObject* Object, bool* bSuccess)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IsInVehicleOstrich");
...
void UAthenaHUD_C::On_Placement_Changed()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Placement Changed");
...
void UAthenaHUD_C::On_Player_Died(const struct FFortPlayerDeathReport& DeathReport)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Player Died");
...
void UAthenaHUD_C::OnDisplayGameOver()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDisplayGameOver");
...
void UAthenaHUD_C::OnReady_9A1EB0104B65CF2D28BDDEB47E4CADCF(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnReady_9A1EB0104B65CF2D28BDDEB47E4CADCF");
...
void UAthenaHUD_C::OnRevived()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRevived");
...
void UAthenaHUD_C::Prepare_Game_Over()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Prepare Game Over");
...
void UAthenaHUD_C::PrepareToShowEndGameUI()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PrepareToShowEndGameUI");
...
void UAthenaHUD_C::ProcessPawnChangeForRCPawn(class UObject* Object)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ProcessPawnChangeForRCPawn");
...
void UAthenaHUD_C::SetupCameraMode()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupCameraMode");
...
void UAthenaHUD_C::UpdateCursorModeVisibility(class FName CursorMode)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateCursorModeVisibility");
...
void UAthenaHUD_C::IsClientNotifiedOfWin(bool* bClientWon, bool* bTeamWon) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IsClientNotifiedOfWin");
...
void UAthenaHUD_C::WidgetContainsChildClass(class UPanelWidget* WidgetToCheckChildren, class UClass* ContainsClass, bool* bContainsChild) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("WidgetContainsChildClass");
