...
void UXpReasonFeed_C::ExecuteUbergraph_XpReasonFeed(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_XpReasonFeed");
...
// Parameters:
// TArray<struct FAthenaMatchXpReward>     XpRewards                                              (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void UXpReasonFeed_C::ImmediatelyShowXpRewards(TArray<struct FAthenaMatchXpReward>& XpRewards)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ImmediatelyShowXpRewards");
...
void UXpReasonFeed_C::Reset_Feed()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Reset Feed");
