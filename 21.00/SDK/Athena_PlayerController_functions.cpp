...
void AAthena_PlayerController_C::ReplicateRotationScaleReset()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ReplicateRotationScaleReset");
...
void AAthena_PlayerController_C::Start_Victory_Royale_Music()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Start Victory Royale Music");
...
void AAthena_PlayerController_C::SpawnUIDownloadOnDemandDirector()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SpawnUIDownloadOnDemandDirector");
...
void AAthena_PlayerController_C::SetupPermissionRecheckTimer()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupPermissionRecheckTimer");
...
void AAthena_PlayerController_C::RevokeItem(TSoftObjectPtr<class UFortWorldItemDefinition> Item)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RevokeItem");
...
void AAthena_PlayerController_C::ReactToPawnPossession(class APawn* PossessedPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ReactToPawnPossession");
...
void AAthena_PlayerController_C::OnReady_B4409EAB4038578B1EBA9DB1586489B9(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnReady_B4409EAB4038578B1EBA9DB1586489B9");
...
void AAthena_PlayerController_C::PlayWinEffects(class APawn* FinisherPawn, const class UFortWeaponItemDefinition* FinishingWeapon, EDeathCause DeathCause, bool bAudioOnly)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PlayWinEffects");
...
void AAthena_PlayerController_C::PlayVictoryStinger(class USoundCue* VictoryStingerCue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PlayVictoryStinger");
...
void AAthena_PlayerController_C::OnMusicPackLoaded(const class UAthenaMusicPackItemDefinition* NewMusicPack, float StartTimeOffset)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnMusicPackLoaded");
...
void AAthena_PlayerController_C::OnLocalInteraction(class AActor* ReceivingActor)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLocalInteraction");
...
void AAthena_PlayerController_C::OnLoaded_F82CC70840156DFAFAF85EB0D93E5E2D(class UObject* Loaded)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLoaded_F82CC70840156DFAFAF85EB0D93E5E2D");
...
void AAthena_PlayerController_C::OnLoaded_C4025C8348E46225485BAE9B58B26060(TSubclassOf<class UObject> Loaded)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLoaded_C4025C8348E46225485BAE9B58B26060");
...
void AAthena_PlayerController_C::K2_OnEnterVolume(class AFortVolume* Volume)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("K2_OnEnterVolume");
...
bool AAthena_PlayerController_C::Is_Creative_Mode()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Is Creative Mode");
...
void AAthena_PlayerController_C::LeftAllVolumes(bool* bLeftVolumes)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LeftAllVolumes");
...
void AAthena_PlayerController_C::K2_OnLeaveVolume(class AFortVolume* Volume)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("K2_OnLeaveVolume");
...
void AAthena_PlayerController_C::Handle_Victory_Royale_Audio(bool Audio_Only)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Handle Victory Royale Audio");
...
void AAthena_PlayerController_C::GrantItem(TSoftObjectPtr<class UFortWorldItemDefinition> Item)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GrantItem");
...
void AAthena_PlayerController_C::FadeAudioComponents(class UAudioComponent* NewMusicComponent, class UAudioComponent* PreviousMusicComponent, class USoundBase* Music, float StartTime)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeAudioComponents");
...
void AAthena_PlayerController_C::ExecuteUbergraph_Athena_PlayerController(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Athena_PlayerController");
