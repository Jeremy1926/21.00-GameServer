...
void UBuildingBar_C::Set_Display_Mode(EFortBuildingInteraction InDisplayMode)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Set Display Mode");
...
void UBuildingBar_C::SetBigHealthMode(bool BigHealth)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetBigHealthMode");
...
void UBuildingBar_C::SetBigHealthPercentFill(float Percent)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetBigHealthPercentFill");
...
void UBuildingBar_C::SetBigHealthValue(const class FText& HP_Text)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetBigHealthValue");
...
void UBuildingBar_C::Update_Current_Durability_Value(float CurrentDurability)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Current Durability Value");
...
void UBuildingBar_C::Update_Current_HP_Value(float Current)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Current HP Value");
...
void UBuildingBar_C::Update_Durability_Text()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Durability Text");
...
void UBuildingBar_C::Update_Max_Durability_Value(float Max)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Max Durability Value");
...
void UBuildingBar_C::Update_Max_HP_Value(float Max)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Max HP Value");
...
void UBuildingBar_C::UpdateBuildingTrap(class ABuildingTrap* BuildingTrap)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateBuildingTrap");
