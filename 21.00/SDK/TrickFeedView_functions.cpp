...
void UTrickFeedView_C::AddTrick(const class FText& TrickName)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AddTrick");
...
void UTrickFeedView_C::CritStyleEvent(bool isCritical_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CritStyleEvent");
...
void UTrickFeedView_C::EventTrickCompliment()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EventTrickCompliment");
...
void UTrickFeedView_C::ExecuteUbergraph_TrickFeedView(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_TrickFeedView");
...
void UTrickFeedView_C::FadeOutMusic()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeOutMusic");
...
void UTrickFeedView_C::GetCalloutText(class FText* Callout)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetCalloutText");
...
void UTrickFeedView_C::HIdeTrickUI()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HIdeTrickUI");
...
void UTrickFeedView_C::SimulateTrick()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SimulateTrick");
...
void UTrickFeedView_C::ToggleCompleteStyle(bool IsComplete)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleCompleteStyle");
...
void UTrickFeedView_C::TrickSequenceCanceled()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TrickSequenceCanceled");
...
void UTrickFeedView_C::TrickSequenceComplete()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TrickSequenceComplete");
...
void UTrickFeedView_C::TrickSequenceFailed()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TrickSequenceFailed");
...
void UTrickFeedView_C::TrickSequenceStarted()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TrickSequenceStarted");
...
void UTrickFeedView_C::UpdateMultiplier(int32 Multiplier_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateMultiplier");
...
void UTrickFeedView_C::UpdateTrickStats(const class FText& StatsText)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateTrickStats");
...
void UTrickFeedView_C::WidgetAnimationEvt_TrickComplete_K2Node_WidgetAnimationEvent_1()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("WidgetAnimationEvt_TrickComplete_K2Node_WidgetAnimationEvent_1");
...
void UTrickFeedView_C::WidgetAnimationEvt_TrickFailed_K2Node_WidgetAnimationEvent_0()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("WidgetAnimationEvt_TrickFailed_K2Node_WidgetAnimationEvent_0");
