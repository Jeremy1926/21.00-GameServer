...
void UKillerInfoWidget_C::ExecuteUbergraph_KillerInfoWidget(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_KillerInfoWidget");
...
void UKillerInfoWidget_C::SetKillerHealthAndShield(float HealthPercent, float ShieldPercent, float OvershieldPercent)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetKillerHealthAndShield");
...
void UKillerInfoWidget_C::SetKillerName(const class FString& PlayerName, const class FString& PlayerId)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetKillerName");
...
void UKillerInfoWidget_C::SetKillerWeaponIconAndName(class UTexture2D* IconTexture, const class UFortWeaponItemDefinition* ItemDef)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetKillerWeaponIconAndName");
...
void UKillerInfoWidget_C::SetNumOfKillerKills(int32 NumOfKillers)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetNumOfKillerKills");
