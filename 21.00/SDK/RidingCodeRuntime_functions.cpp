...
void URidableComponent::OnRiderStartedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRiderStartedEmote");
...
void URidableComponent::OnRiderStoppedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRiderStoppedEmote");
...
void URidableComponent::PredictRunSpeedForClient(const float NewRunSpeed) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PredictRunSpeedForClient");
...
void URiderComponent::HandleTrackingRidables()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleTrackingRidables");
