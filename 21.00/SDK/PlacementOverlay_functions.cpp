...
void UPlacementOverlay_C::EventXPLayout(class FName Placement)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EventXPLayout");
...
void UPlacementOverlay_C::ExecuteUbergraph_PlacementOverlay(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_PlacementOverlay");
...
void UPlacementOverlay_C::New_Item_Anim_End()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("New Item Anim End");
...
void UPlacementOverlay_C::New_Item_Anim_Start()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("New Item Anim Start");
...
void UPlacementOverlay_C::ShowLosingPlacement()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShowLosingPlacement");
...
void UPlacementOverlay_C::ShowTiePlacement()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShowTiePlacement");
...
void UPlacementOverlay_C::ShowWinningPlacement()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShowWinningPlacement");
...
void UPlacementOverlay_C::XP_Layout_Anim_Finished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("XP Layout Anim Finished");
