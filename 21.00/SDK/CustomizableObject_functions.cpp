...
void UCustomizableObject::LoadMaskOutCache()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LoadMaskOutCache");
...
void UCustomizableObject::UnloadMaskOutCache()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UnloadMaskOutCache");
...
int32 UCustomizableObjectInstance::CurrentParamRange(const class FString& ParamName) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CurrentParamRange");
...
bool UCustomizableObjectSystem::AreEnginePatchesPresent() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AreEnginePatchesPresent");
