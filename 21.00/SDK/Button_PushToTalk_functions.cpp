...
void UButton_PushToTalk_C::ExecuteUbergraph_Button_PushToTalk(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Button_PushToTalk");
...
void UButton_PushToTalk_C::OnHUDStateUpdate(const struct FFortHUDState& NewState)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnHUDStateUpdate");
...
void UButton_PushToTalk_C::PTTClicked()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PTTClicked");
...
void UButton_PushToTalk_C::Update_Visibility(EPTTState PTT_State)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Visibility");
