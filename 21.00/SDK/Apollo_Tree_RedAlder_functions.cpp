...
void AApollo_Tree_RedAlder_C::activateDeathFXOverride()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("activateDeathFXOverride");
...
void AApollo_Tree_RedAlder_C::ExecuteUbergraph_Apollo_Tree_RedAlder(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Apollo_Tree_RedAlder");
...
void AApollo_Tree_RedAlder_C::initRandomUndergrowth()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("initRandomUndergrowth");
