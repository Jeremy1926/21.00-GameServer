...
void UAthenaMatchStatsPartial_C::ExecuteUbergraph_AthenaMatchStatsPartial(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaMatchStatsPartial");
...
void UAthenaMatchStatsPartial_C::OnRewardsAvailable()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRewardsAvailable");
...
void UAthenaMatchStatsPartial_C::OnStatsAvailable()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnStatsAvailable");
...
void UAthenaMatchStatsPartial_C::OnTeamStatsAvailable()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnTeamStatsAvailable");
...
void UAthenaMatchStatsPartial_C::SetMatchReport(class UAthenaPlayerMatchReport* Report)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetMatchReport");
