...
void ABP_StormMeshRotator_C::SetStormProgression(float Progression)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetStormProgression");
...
void ABP_StormMeshRotator_C::setStormMeshVisibility(bool bEnabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("setStormMeshVisibility");
...
void ABP_StormMeshRotator_C::initializeMobileStormSphere()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("initializeMobileStormSphere");
...
void ABP_StormMeshRotator_C::getSphereEnabled(bool* Enabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("getSphereEnabled");
...
void ABP_StormMeshRotator_C::ExecuteUbergraph_BP_StormMeshRotator(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_StormMeshRotator");
