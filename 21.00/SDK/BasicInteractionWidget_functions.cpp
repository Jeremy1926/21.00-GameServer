...
void UBasicInteractionWidget_C::ExecuteUbergraph_BasicInteractionWidget(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BasicInteractionWidget");
...
void UBasicInteractionWidget_C::InitBasicInteraction()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitBasicInteraction");
...
void UBasicInteractionWidget_C::UpdateDescription(const class FText& Description_0, const struct FLinearColor& DescriptionColor, const class FText& SubDescription, const struct FLinearColor& SubDescriptionColor, int32 InteractionCount)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateDescription");
...
void UBasicInteractionWidget_C::UpdateMultiInteractionCount(int32 NewInteractionCount)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateMultiInteractionCount");
