...
void UGA_Athena_Knockback_Parent_C::CalculateDistanceMod(const struct FVector& TargetLocation, const struct FVector& KnockOrigin, float* ModAmount, bool* AboveMax)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CalculateDistanceMod");
...
void UGA_Athena_Knockback_Parent_C::CalculateVelocityMaintained(class AActor* LaunchTarget, const struct FVector& LaunchMagIn, struct FVector* ModifiedLaunchSpeed)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CalculateVelocityMaintained");
...
struct FVector UGA_Athena_Knockback_Parent_C::CalcVehicleMult(const struct FVector& InVec)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CalcVehicleMult");
...
float UGA_Athena_Knockback_Parent_C::CheckGravityScale(const struct FGameplayAttribute& Attribute_Gravity_Scale)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CheckGravityScale");
...
void UGA_Athena_Knockback_Parent_C::DoLaunch(const struct FVector& Vel)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DoLaunch");
...
void UGA_Athena_Knockback_Parent_C::ExecuteUbergraph_GA_Athena_Knockback_Parent(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GA_Athena_Knockback_Parent");
...
void UGA_Athena_Knockback_Parent_C::FailsafeEndAbility()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FailsafeEndAbility");
...
void UGA_Athena_Knockback_Parent_C::Find_Launcher(class AActor* DefaultLauncher, class AActor** LauncherOut)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Find Launcher");
...
void UGA_Athena_Knockback_Parent_C::Get_Initial_Knock_Mag(const struct FVector& Direction, struct FVector* LaunchMag)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Get Initial Knock Mag");
...
struct FVector UGA_Athena_Knockback_Parent_C::GetKnockbackOrigin(class AActor* OriginActor)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetKnockbackOrigin");
...
struct FVector UGA_Athena_Knockback_Parent_C::GetTargetLocation()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetTargetLocation");
...
void UGA_Athena_Knockback_Parent_C::LaunchFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LaunchFinished");
...
void UGA_Athena_Knockback_Parent_C::OnFinish_78B7A0C144DB79535B9890B75AE5F853()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnFinish_78B7A0C144DB79535B9890B75AE5F853");
...
void UGA_Athena_Knockback_Parent_C::OnTimedOut_C8C9B5D948887DE06B469CAFC5621C02()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnTimedOut_C8C9B5D948887DE06B469CAFC5621C02");
...
void UGA_Athena_Knockback_Parent_C::OnTimedOutAndDestinationReached_C8C9B5D948887DE06B469CAFC5621C02()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnTimedOutAndDestinationReached_C8C9B5D948887DE06B469CAFC5621C02");
...
void UGA_Athena_Knockback_Parent_C::OwningPawnDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OwningPawnDied");
