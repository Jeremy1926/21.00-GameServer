...
void UCommonBigHealthBar_C::ExecuteUbergraph_CommonBigHealthBar(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_CommonBigHealthBar");
...
void UCommonBigHealthBar_C::InitializeBar()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeBar");
...
void UCommonBigHealthBar_C::SetColors(const struct FLinearColor& ColorA, const struct FLinearColor& ColorB, const struct FLinearColor& BevelColor, const struct FLinearColor& BaseplateColor)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetColors");
...
void UCommonBigHealthBar_C::SetSwitcherTextIndex(int32 Index_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetSwitcherTextIndex");
...
void UCommonBigHealthBar_C::Update_HP_Fill(float Percent)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update HP Fill");
...
void UCommonBigHealthBar_C::Update_HP_Fill_Bar()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update HP Fill Bar");
...
void UCommonBigHealthBar_C::Update_HP_Text(const class FText& HP_Text)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update HP Text");
