...
void UAthenaItemDetailsHeader_C::ExecuteUbergraph_AthenaItemDetailsHeader(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaItemDetailsHeader");
...
void UAthenaItemDetailsHeader_C::HandleDifferentItemToCompareSet()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleDifferentItemToCompareSet");
...
void UAthenaItemDetailsHeader_C::HandleDifferentItemToDetailSet()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleDifferentItemToDetailSet");
...
void UAthenaItemDetailsHeader_C::SetItemCost(class AActor* Actor)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetItemCost");
...
void UAthenaItemDetailsHeader_C::SetStyles()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetStyles");
...
void UAthenaItemDetailsHeader_C::UpdateItemsForWidgets()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateItemsForWidgets");
