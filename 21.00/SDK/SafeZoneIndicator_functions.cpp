...
void ASafeZoneIndicator_C::VolumetricStormFadeTimeline__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("VolumetricStormFadeTimeline__UpdateFunc");
...
void ASafeZoneIndicator_C::VolumetricStormFadeTimeline__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("VolumetricStormFadeTimeline__FinishedFunc");
...
void ASafeZoneIndicator_C::Trigger_Distant_Storm_Oneshot()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Trigger Distant Storm Oneshot");
...
void ASafeZoneIndicator_C::stormy(float NewParam)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("stormy");
...
void ASafeZoneIndicator_C::StormFadeTimeline__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StormFadeTimeline__UpdateFunc");
...
void ASafeZoneIndicator_C::StormFadeTimeline__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StormFadeTimeline__FinishedFunc");
...
void ASafeZoneIndicator_C::Stop_Distant_Storm_Oneshots()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Stop Distant Storm Oneshots");
...
void ASafeZoneIndicator_C::Start_Megastorm_Audio()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Start Megastorm Audio");
...
void ASafeZoneIndicator_C::ResetSafeZoneScale()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ResetSafeZoneScale");
...
void ASafeZoneIndicator_C::Pre_Damage_Audio_Ramp__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Pre Damage Audio Ramp__UpdateFunc");
...
void ASafeZoneIndicator_C::Pre_Damage_Audio_Ramp__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Pre Damage Audio Ramp__FinishedFunc");
...
void ASafeZoneIndicator_C::Play_Storm_Grow_Audio()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Play Storm Grow Audio");
...
void ASafeZoneIndicator_C::OnSafeZoneStateChange(EFortSafeZoneState NewState, bool bInitial)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSafeZoneStateChange");
...
void ASafeZoneIndicator_C::OnForceStopStormFadeTimer()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnForceStopStormFadeTimer");
...
void ASafeZoneIndicator_C::OnForceResetCloudStartingBias()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnForceResetCloudStartingBias");
...
void ASafeZoneIndicator_C::OnBeginStartingStateEffectsEvent()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnBeginStartingStateEffectsEvent");
...
void ASafeZoneIndicator_C::Megastorm_Pre_Damage_Tell()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Megastorm Pre Damage Tell");
...
void ASafeZoneIndicator_C::InitClosestPointAudio()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitClosestPointAudio");
...
void ASafeZoneIndicator_C::HandleInsideOutsideMix()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleInsideOutsideMix");
...
void ASafeZoneIndicator_C::GetSafeZoneIndicatorMID(class UMaterialInstanceDynamic** Mid)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSafeZoneIndicatorMID");
...
void ASafeZoneIndicator_C::GetRandomPointOnBoundary(struct FVector* Position)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRandomPointOnBoundary");
...
void ASafeZoneIndicator_C::GetRandomPointInPlayerDir(struct FVector* Position)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRandomPointInPlayerDir");
...
void ASafeZoneIndicator_C::GetAthenaGameState(class AAthena_GameState_C** AthenaGS)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetAthenaGameState");
...
void ASafeZoneIndicator_C::ExecuteUbergraph_SafeZoneIndicator(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_SafeZoneIndicator");
...
void ASafeZoneIndicator_C::DestroySafeZone()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DestroySafeZone");
