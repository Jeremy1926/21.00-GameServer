...
void ACar_DEFAULT_C::BounceCar__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BounceCar__FinishedFunc");
...
void ACar_DEFAULT_C::BounceCar__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BounceCar__UpdateFunc");
...
void ACar_DEFAULT_C::Construct_Clean_Up_Lights()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Construct Clean Up Lights");
...
void ACar_DEFAULT_C::construct_ValidateLightsOnVars(bool* doesHaveLights)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("construct_ValidateLightsOnVars");
...
void ACar_DEFAULT_C::ExecuteUbergraph_Car_DEFAULT(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Car_DEFAULT");
...
void ACar_DEFAULT_C::FadeSirenLight()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeSirenLight");
...
void ACar_DEFAULT_C::FireOffCarAlarm()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FireOffCarAlarm");
...
void ACar_DEFAULT_C::generateMeshMIDs()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("generateMeshMIDs");
...
void ACar_DEFAULT_C::getCarMatsForLights(TArray<class UMaterialInstanceDynamic*>* outMaterials)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("getCarMatsForLights");
...
void ACar_DEFAULT_C::Hit_Bounce_Finished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Hit Bounce Finished");
...
float ACar_DEFAULT_C::MaterialEditorSine(float Look_up_value, float Period)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MaterialEditorSine");
...
void ACar_DEFAULT_C::OnBounceAnimationUpdate(const struct FFortBounceData& Data)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnBounceAnimationUpdate");
...
void ACar_DEFAULT_C::Player_jump_based_bounce_()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Player jump based bounce ");
...
void ACar_DEFAULT_C::PlayJumpOnCarSound(const struct FVector& Location)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PlayJumpOnCarSound");
...
void ACar_DEFAULT_C::Randomize_the_target_brightness_levels()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Randomize the target brightness levels");
...
void ACar_DEFAULT_C::Set_Light_Brightness(float Zero_1_Intensity, bool Include_Second_Emissive_Channel, bool Force)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Set Light Brightness");
...
void ACar_DEFAULT_C::setcanmakebouncingnoisetrue()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("setcanmakebouncingnoisetrue");
...
float ACar_DEFAULT_C::SetCarAlarmEnabledBasedOnLocation(const struct FVector& Location, bool* NewParam)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetCarAlarmEnabledBasedOnLocation");
...
void ACar_DEFAULT_C::StartSirenLight()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartSirenLight");
...
void ACar_DEFAULT_C::StopCarAlarmFromPlaying()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StopCarAlarmFromPlaying");
...
void ACar_DEFAULT_C::Timeline_2__FireOffNoise__EventFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Timeline_2__FireOffNoise__EventFunc");
...
void ACar_DEFAULT_C::toggle_light_visibility(bool bNewVisibility)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("toggle light visibility");
...
void ACar_DEFAULT_C::TriggerLowHealthParticleEffect()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TriggerLowHealthParticleEffect");
...
void ACar_DEFAULT_C::validateLightVisibility()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("validateLightVisibility");
