...
void AB_Melee_Blade_Real_C::OnPlayImpactFX(const struct FHitResult& HitResult, EPhysicalSurface ImpactPhysicalSurface, class UFXSystemComponent* SpawnedPSC)
{
...
void AB_Melee_Blade_Real_C::ExecuteUbergraph_B_Melee_Blade_Real(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_B_Melee_Blade_Real");
