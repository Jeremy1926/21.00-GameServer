...
void AB_Prj_Athena_ChillBronco_C::DoHealCheck(const TArray<class AActor*>& HitActors_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DoHealCheck");
...
void AB_Prj_Athena_ChillBronco_C::EnableCollision()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EnableCollision");
...
void AB_Prj_Athena_ChillBronco_C::ExecuteUbergraph_B_Prj_Athena_ChillBronco(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_B_Prj_Athena_ChillBronco");
...
void AB_Prj_Athena_ChillBronco_C::GetMissingHealth(float* MissingHealth)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetMissingHealth");
...
void AB_Prj_Athena_ChillBronco_C::GetMissingShield(float* MissingShield)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetMissingShield");
...
void AB_Prj_Athena_ChillBronco_C::HealPlayer()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HealPlayer");
...
void AB_Prj_Athena_ChillBronco_C::KillDelay()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("KillDelay");
...
void AB_Prj_Athena_ChillBronco_C::QuestCheckSquadMember(class AFortPawn* PlayerPawnHit)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("QuestCheckSquadMember");
...
void AB_Prj_Athena_ChillBronco_C::ResetVariables()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ResetVariables");
...
void AB_Prj_Athena_ChillBronco_C::UpdateHealthShieldHealAmounts()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateHealthShieldHealAmounts");
