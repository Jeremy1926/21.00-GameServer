...
void ABP_ReplayPC_Athena_C::OnZoomOutBegin()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnZoomOutBegin");
...
void ABP_ReplayPC_Athena_C::OnZoomInEnd()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnZoomInEnd");
...
void ABP_ReplayPC_Athena_C::OnZoomInBegin()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnZoomInBegin");
...
void ABP_ReplayPC_Athena_C::Update_Sound_Mix()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Sound Mix");
...
void ABP_ReplayPC_Athena_C::SetSkydivingAudioEnabled(bool Enabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetSkydivingAudioEnabled");
...
void ABP_ReplayPC_Athena_C::OnReplayHudVisibilityChanged(const EHudVisibilityState IsVisible)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnReplayHudVisibilityChanged");
...
void ABP_ReplayPC_Athena_C::OnNotifyNewPlaybackMultiplier(float NewMultiplier)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnNotifyNewPlaybackMultiplier");
...
void ABP_ReplayPC_Athena_C::OnZoomOutEnd()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnZoomOutEnd");
...
class USoundBase* ABP_ReplayPC_Athena_C::GetSkydivingSound()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSkydivingSound");
...
void ABP_ReplayPC_Athena_C::ExecuteUbergraph_BP_ReplayPC_Athena(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_ReplayPC_Athena");
...
void ABP_ReplayPC_Athena_C::On_Pause_State_Changed(bool bPaused)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Pause State Changed");
...
void ABP_ReplayPC_Athena_C::Looping_Audio_Update()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Looping Audio Update");
...
void ABP_ReplayPC_Athena_C::IsGameplayCamera(bool* IsGameplayCamera_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IsGameplayCamera");
...
void ABP_ReplayPC_Athena_C::_Speedup_Loops(float Playback_Multiplier)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction(" Speedup Loops");
...
void ABP_ReplayPC_Athena_C::Handle_Parachute_Audio_State()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Handle Parachute Audio State");
