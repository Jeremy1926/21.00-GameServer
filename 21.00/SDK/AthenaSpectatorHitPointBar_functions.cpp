...
void UAthenaSpectatorHitPointBar_C::ChangeTextVisibility(bool bIsVisible)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ChangeTextVisibility");
...
void UAthenaSpectatorHitPointBar_C::ExecuteUbergraph_AthenaSpectatorHitPointBar(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaSpectatorHitPointBar");
...
void UAthenaSpectatorHitPointBar_C::OnCurrentValueChanged(float InCurrentValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnCurrentValueChanged");
...
void UAthenaSpectatorHitPointBar_C::OnDBNOChanged(bool bInIsDBNO)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDBNOChanged");
...
void UAthenaSpectatorHitPointBar_C::OnDeltaValueChanged(float InDeltaValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDeltaValueChanged");
...
void UAthenaSpectatorHitPointBar_C::UpdateCurrentValueText(float InCurrentValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateCurrentValueText");
...
void UAthenaSpectatorHitPointBar_C::UpdateMaxValueText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateMaxValueText");
