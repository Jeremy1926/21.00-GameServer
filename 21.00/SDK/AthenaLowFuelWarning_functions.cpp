...
void UAthenaLowFuelWarning_C::ExecuteUbergraph_AthenaLowFuelWarning(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaLowFuelWarning");
...
void UAthenaLowFuelWarning_C::OnEnterVehicleDriver_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnterVehicleDriver_Bind");
...
void UAthenaLowFuelWarning_C::OnEnterVehiclePassenger_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnterVehiclePassenger_Bind");
...
void UAthenaLowFuelWarning_C::OnExitVehicle_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnExitVehicle_Bind");
...
void UAthenaLowFuelWarning_C::OnFuelAboveThreshold_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnFuelAboveThreshold_Bind");
...
void UAthenaLowFuelWarning_C::OnFuelBelowThreshold_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnFuelBelowThreshold_Bind");
...
void UAthenaLowFuelWarning_C::OnNotOutOfFuel_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnNotOutOfFuel_Bind");
...
void UAthenaLowFuelWarning_C::OnOutOfFuel_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnOutOfFuel_Bind");
