...
void AB_ToyBasketball_Base_C::BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent_0, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");
...
void AB_ToyBasketball_Base_C::ExecuteUbergraph_B_ToyBasketball_Base(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_B_ToyBasketball_Base");
...
void AB_ToyBasketball_Base_C::LerpIntoGoalTimeline__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LerpIntoGoalTimeline__FinishedFunc");
...
void AB_ToyBasketball_Base_C::LerpIntoGoalTimeline__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LerpIntoGoalTimeline__UpdateFunc");
...
void AB_ToyBasketball_Base_C::OnHitTarget(const struct FVector& StartPos, const struct FVector& EndPos)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnHitTarget");
...
void AB_ToyBasketball_Base_C::OnRep_IdealLerpEndPos()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_IdealLerpEndPos");
...
void AB_ToyBasketball_Base_C::PlayScoringAnim()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PlayScoringAnim");
...
void AB_ToyBasketball_Base_C::PlayScoringCueAndDestruct(int32 ScoreAmount, const struct FVector& TargetStartPos, const struct FVector& TargetEndPos)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PlayScoringCueAndDestruct");
