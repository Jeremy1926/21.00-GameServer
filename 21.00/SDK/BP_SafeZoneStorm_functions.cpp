...
void ABP_SafeZoneStorm_C::ShowStormScreenEffect(bool Show)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShowStormScreenEffect");
...
void ABP_SafeZoneStorm_C::ShowClouds(float Amount)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShowClouds");
...
void ABP_SafeZoneStorm_C::MobileClouds(bool Mobile)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MobileClouds");
...
void ABP_SafeZoneStorm_C::ExecuteUbergraph_BP_SafeZoneStorm(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_SafeZoneStorm");
