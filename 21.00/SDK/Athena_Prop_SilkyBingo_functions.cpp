...
void AAthena_Prop_SilkyBingo_C::Apply_Water_if_Curie_Enabled(class AActor* Instigator_0, class AActor* Target)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Apply Water if Curie Enabled");
...
bool AAthena_Prop_SilkyBingo_C::Distance_Check_for_Camera_Lens_Effect(class AActor* Instigator_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Distance Check for Camera Lens Effect");
...
void AAthena_Prop_SilkyBingo_C::ExecuteUbergraph_Athena_Prop_SilkyBingo(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Athena_Prop_SilkyBingo");
