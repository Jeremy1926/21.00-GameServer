...
// Parameters:
// class AFortAthenaVehicle*               Vehicle_Actor                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Prj_Petrol_C::Check_If_NoFuel_Tag_Present(class AFortAthenaVehicle* Vehicle_Actor)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("Check If NoFuel Tag Present");

	Params::B_Prj_Petrol_C_Check_If_NoFuel_Tag_Present Parms{};

	Parms.Vehicle_Actor = Vehicle_Actor;
...
void AB_Prj_Petrol_C::ExecuteUbergraph_B_Prj_Petrol(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_B_Prj_Petrol");
