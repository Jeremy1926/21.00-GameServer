...
TMap<struct FGenericKeyType, int64> USolarisMapLibrary::Concatenate(const TMap<struct FGenericKeyType, int64>& Lhs, const TMap<struct FGenericKeyType, int64>& Rhs)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("Concatenate");
...
int64 USolarisMapLibrary::Count(const TMap<struct FGenericKeyType, struct FGenericValueType>& Map)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("Count");
...
void USolarisMathLibrary_Int::ConvertI32I64(int64 Rhs)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("ConvertI32I64");
...
void USolarisUtilLibrary::CallDelegate()
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("CallDelegate");
...
void USolarisUtilLibrary::GetDelegateForInterfaceMethod(class UObject* Object, class FName MethodName)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("GetDelegateForInterfaceMethod");
...
void UVerseDynamicallyTypedValueLibrary::MakeRuntimeTypeInt32()
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("MakeRuntimeTypeInt32");
...
void UVerseDynamicallyTypedValueLibrary::MakeRuntimeTypeInt8()
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("MakeRuntimeTypeInt8");
