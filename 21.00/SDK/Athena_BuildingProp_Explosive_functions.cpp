...
void AAthena_BuildingProp_Explosive_C::ApplyDamageToActor(class AActor* Actor_to_Damage)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ApplyDamageToActor");
...
void AAthena_BuildingProp_Explosive_C::DeactivateEmitter()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DeactivateEmitter");
...
void AAthena_BuildingProp_Explosive_C::DestroyHitActors(class AActor* HitActor)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DestroyHitActors");
...
void AAthena_BuildingProp_Explosive_C::ExecuteExplosionOnActor(class AActor* ActorToExplode)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteExplosionOnActor");
...
void AAthena_BuildingProp_Explosive_C::ExecuteFireApplicationInRadiusIfCurieEnabled(class AActor* FireApplicationTarget)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteFireApplicationInRadiusIfCurieEnabled");
...
void AAthena_BuildingProp_Explosive_C::ExecuteUbergraph_Athena_BuildingProp_Explosive(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Athena_BuildingProp_Explosive");
...
void AAthena_BuildingProp_Explosive_C::ExplodeAndDieStaggered()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExplodeAndDieStaggered");
...
void AAthena_BuildingProp_Explosive_C::FastExplodeAndDie()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FastExplodeAndDie");
...
void AAthena_BuildingProp_Explosive_C::LaunchActor(class AActor* Actor_To_Launch)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("LaunchActor");
...
void AAthena_BuildingProp_Explosive_C::ManuallyTriggerFuse()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ManuallyTriggerFuse");
...
void AAthena_BuildingProp_Explosive_C::MinigameIsInProgress(bool IgnoreWarmUp, bool* HasValidMinigame, bool* IsRunning)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MinigameIsInProgress");
...
void AAthena_BuildingProp_Explosive_C::OnCompletion(bool WasCancelled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnCompletion");
...
void AAthena_BuildingProp_Explosive_C::OnFireFx()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnFireFx");
...
void AAthena_BuildingProp_Explosive_C::OnRep_DamageStateNotify()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_DamageStateNotify");
...
void AAthena_BuildingProp_Explosive_C::OnRep_ExplosiveFxRepNotify()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_ExplosiveFxRepNotify");
...
void AAthena_BuildingProp_Explosive_C::ShouldCancelExplosion(bool* Return)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldCancelExplosion");
...
void AAthena_BuildingProp_Explosive_C::StartDetonation()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartDetonation");
...
void AAthena_BuildingProp_Explosive_C::StopGrowAudio()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StopGrowAudio");
...
void AAthena_BuildingProp_Explosive_C::TriggeredByGasPump()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TriggeredByGasPump");
