...
const struct FFortItemEntry UCampsiteFunctionLibraryNative::GetItemEntryCopyFromWeapon(const class AFortWeapon* Weapon)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("GetItemEntryCopyFromWeapon");
...
void UCampsiteFunctionLibraryNative::SetHealthOnPropFromItemEntry(const struct FFortItemEntry& FortItem, class ABuildingProp* BuildingProp)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("SetHealthOnPropFromItemEntry");
...
void UCampsiteFunctionLibraryNative::StoreHealthOnPickupFromProp(const class ABuildingProp* BuildingProp, class AFortPickup* PickUp)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("StoreHealthOnPickupFromProp");
