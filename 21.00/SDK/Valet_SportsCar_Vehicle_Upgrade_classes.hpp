...
public:
	...
	struct FPointerToUberGraphFrame               UberGraphFrame_Valet_SportsCar_Vehicle_Upgrade_C;  // 0x2BF8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AValet_SportsCar_Vehicle_Upgrade_C) == 0x002C00, "Wrong size on AValet_SportsCar_Vehicle_Upgrade_C");
static_assert(offsetof(AValet_SportsCar_Vehicle_Upgrade_C, UberGraphFrame_Valet_SportsCar_Vehicle_Upgrade_C) == 0x002BF8, "Member 'AValet_SportsCar_Vehicle_Upgrade_C::UberGraphFrame_Valet_SportsCar_Vehicle_Upgrade_C' has a wrong offset!");
