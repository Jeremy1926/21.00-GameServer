...
void UUIEmitterElement_C::EndofLife()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EndofLife");
...
void UUIEmitterElement_C::EventDestroy()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EventDestroy");
...
void UUIEmitterElement_C::ExecuteUbergraph_UIEmitterElement(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_UIEmitterElement");
...
void UUIEmitterElement_C::StartAnim()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartAnim");
