...
void UAthenaIndicatorLayer_C::CreateInterestIndicatorWidget()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CreateInterestIndicatorWidget");
...
void UAthenaIndicatorLayer_C::ExecuteUbergraph_AthenaIndicatorLayer(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaIndicatorLayer");
...
void UAthenaIndicatorLayer_C::HandleOnPointOfInterestAdded(class AActor* PointOfInterest, const class FText& DisplayText, class UTexture2D* DisplayImage, bool SpecifyColor, const struct FLinearColor& ImageColor)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleOnPointOfInterestAdded");
...
void UAthenaIndicatorLayer_C::HandleOnPointOfInterestRemoved(class AActor* PointOfInterest)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleOnPointOfInterestRemoved");
...
void UAthenaIndicatorLayer_C::OnLoaded_0BEC012C4A6FDC641FED58A2C3D8BCE1(TSubclassOf<class UObject> Loaded)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLoaded_0BEC012C4A6FDC641FED58A2C3D8BCE1");
...
void UAthenaIndicatorLayer_C::OnLoaded_B8452F9043C3C2A55EA7759DF18A2345(TSubclassOf<class UObject> Loaded)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLoaded_B8452F9043C3C2A55EA7759DF18A2345");
...
void UAthenaIndicatorLayer_C::OnReady_E8925CF449ED5EC2B87AD4AA3B994A28(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnReady_E8925CF449ED5EC2B87AD4AA3B994A28");
