...
void UAthenaHUD_PickupItemWidget_C::ExecuteUbergraph_AthenaHUD_PickupItemWidget(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaHUD-PickupItemWidget");
...
void UAthenaHUD_PickupItemWidget_C::InitializeInteractionFailureText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeInteractionFailureText");
...
void UAthenaHUD_PickupItemWidget_C::InitializeItemData()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeItemData");
...
void UAthenaHUD_PickupItemWidget_C::SetPickup(class AFortPickup* NewPickup)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetPickup");
