...
void UQuestUpdateEntry_C::ExecuteUbergraph_QuestUpdateEntry(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_QuestUpdateEntry");
...
void UQuestUpdateEntry_C::QuestItemSet(class UFortQuestItem* QuestItemToCheck)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("QuestItemSet");
...
void UQuestUpdateEntry_C::SetupAsAnnouncement()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupAsAnnouncement");
...
void UQuestUpdateEntry_C::StartQuestIntro()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartQuestIntro");
...
void UQuestUpdateEntry_C::StartQuestIntroBP()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartQuestIntroBP");
...
void UQuestUpdateEntry_C::StartQuestOutro()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartQuestOutro");
