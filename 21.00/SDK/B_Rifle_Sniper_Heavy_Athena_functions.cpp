...
void AB_Rifle_Sniper_Heavy_Athena_C::CalculateTraceDistance(struct FVector* StartPoint, struct FVector* EndPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CalculateTraceDistance");
...
void AB_Rifle_Sniper_Heavy_Athena_C::ExecuteUbergraph_B_Rifle_Sniper_Heavy_Athena(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_B_Rifle_Sniper_Heavy_Athena");
...
void AB_Rifle_Sniper_Heavy_Athena_C::Muzzle_Flash_FX(bool Persistent_Fire)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Rifle_Sniper_Heavy_Athena_C_Muzzle_Flash_FX Parms{};
