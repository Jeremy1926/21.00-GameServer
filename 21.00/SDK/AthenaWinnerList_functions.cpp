...
void UAthenaWinnerList_C::ClearList()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ClearList");
...
void UAthenaWinnerList_C::ExecuteUbergraph_AthenaWinnerList(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaWinnerList");
...
void UAthenaWinnerList_C::OnRep_isWinner()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_isWinner");
...
void UAthenaWinnerList_C::OnWinnersAnnounced(const struct FAthenaWinnerInfo& WinnerInfo)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnWinnersAnnounced");
...
void UAthenaWinnerList_C::TimeoutDuration(float Duration)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TimeoutDuration");
...
void UAthenaWinnerList_C::UpdateWinnerList()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateWinnerList");
