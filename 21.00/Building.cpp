...
void Building::ServerBeginEditingBuildingActor(UObject* Context, FFrame& Stack)
{
	...
	Building->SetNetDormancy(ENetDormancy::DORM_Awake);
	Building->EditingPlayer = (AFortPlayerStateAthena *) PlayerController->PlayerState;
...
void Building::ServerCreateBuildingAndSpawnDeco(UObject* Context, FFrame& Stack) {
	...
	auto bIgnoreCanAffordCheck = UFortKismetLibrary::DoesItemDefinitionHaveGameplayTag(ItemDefinition, FGameplayTag(L"Trap.ExtraPiece.Cost.Ignore"));
